...
1. **Gravitational Wave Echoes:** Strict prediction of $\Delta t_{\rm echo} = 22.00 \pm 0.01$ ms spin-corrected for a 65 $M_\odot$ black hole merger (parameter-free and highly robust to $M_{\Omega,0}$ variance, LIGO/Virgo testable).
