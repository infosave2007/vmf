...
| 2 | $M_{\max} = 2.05\,M_\odot$ (computed from the canonical EOS, [nvg_ns_parameter_scan.py](verification/nvg_ns_parameter_scan.py)) | PSR J0740+6620: $2.08 \pm 0.07\,M_\odot$ ($-0.4\sigma$); any confirmed NS above $\sim 2.2\,M_\odot$ excludes the model | ⚠️ Compatible, edge-falsifiable |
| 3 | $R_{1.4} = 12.55$ km (computed from the canonical EOS) | NICER J0030: $12.2 \pm 0.5$ km ($+0.7\sigma$); J0437: $11.4 \pm 1.0$ km ($+1.2\sigma$); $R_{1.4} < 12.0$ km would exclude the model | ⚠️ Compatible, edge-falsifiable |
