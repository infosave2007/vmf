...
- **Напряжение слабого линзирования $S_8$:** Разрешает $3.3\sigma$ дефицит роста структур. NVG выводит $S_8 \approx 0.778$ за счет мелкомасштабного подавления регулярными ядрами темной материи из ПЧД, что совпадает с консенсусом DES/DESI ($0.776 \pm 0.017$).
