...
### Прямые подтверждения (9/9 совпадений)
...
| Диэлектронные спектры HADES | VMF: масса $\rho$-мезона падает на ~24% при $2n_0$; полный спектр Брейта-Вигнера рассчитан (`nvg_observables_A_B_C.py`) | Модификация спектра в среде обнаружена; уширение и сдвиг массы наблюдаются | 🟡 Частично (количественный шаблон готов) |
