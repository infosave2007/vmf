...
| **Гравитационное эхо** | Интервал эхо $\Delta t \approx 0.022$ с ($65\,M_\odot$) с затуханием амплитуды $A_n \propto (1 - \mathcal{T})^n$ | Готовы шаблоны для согласованной фильтрации; ведется целевой поиск в архивах LIGO O4/O5 |
