...
Специальный пакет статистических тестов (`verification/nvg_observational_data_fit.py` и `verification/nvg_new_directions_verification.py`) верифицирует модель по реальным данным космических и гравитационных обсерваторий:
