...
**Легенда статусов:** ✅ совместимо с данными · 📏 интервальное предсказание · 🔭 форвардное предсказание (измерений ещё нет) · ⚙️ калибровка / проверка согласованности · ⚪ нуль-тест · 📐 математический результат (не экспериментальное подтверждение) · ❓ гипотеза · ❌ открытая проблема / отозвано · ⏳ ожидает эксперимента. Для фальсифицируемых строк указано измерение, которое исключит модель. Статусы даны построчно; глобальная статистика вычислена в [nvg_global_significance.py](verification/nvg_global_significance.py): из 57 строк 8 — независимые количественные тесты, совместно дающие $\chi^2_{\rm red} = 0.63$ ($p = 0.75$ — совместимо и не подозрительно хорошо), максимальный пул ($+1.5\sigma$, J0437) ниже ожидания $\sim 2.4\sigma$ с поправкой на множественность.
