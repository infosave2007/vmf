...
| 54 | Критическая масса горизонта | $M_{\rm crit} \approx 0.99\,M_\odot$. Объекты легче этого порога (например, первичные ЧД) не могут сформировать горизонт событий. Примечание: это фундаментальный гравитационный предел, полностью независимый от астрофизического звёздного "mass gap" ($2-5\,M_\odot$), вызванного механикой сверхновых. | 🔭 Прямое предсказание |
