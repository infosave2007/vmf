...
| 2 | $M_{\max} = 2.05\,M_\odot$ (вычислено из канонического EOS, [nvg_ns_parameter_scan.py](verification/nvg_ns_parameter_scan.py)) | PSR J0740+6620: $2.08 \pm 0.07\,M_\odot$ ($-0.4\sigma$); любая подтверждённая НЗ тяжелее $\sim 2.2\,M_\odot$ исключает модель | ⚠️ Совместимо, фальсифицируемо на краю |
| 3 | $R_{1.4} = 12.55$ км (вычислено из канонического EOS) | NICER J0030: $12.2 \pm 0.5$ км ($+0.7\sigma$); J0437: $11.4 \pm 1.0$ км ($+1.2\sigma$); $R_{1.4} < 12.0$ км исключает модель | ⚠️ Совместимо, фальсифицируемо на краю |
