...
Новый пакет из 8 скриптов в `verification/` (только стандартная библиотека Python, воспроизводятся одной командой). Каждый расчёт — либо замкнутое тождество, либо forward-предсказание с указанным каналом фальсификации; честные аудиты расхождений сохранены в выводах скриптов.
