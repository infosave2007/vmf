...
- 🔥 *Семь теорем вакуумного конденсата: от ядерной материи до квантовой механики* ([PDF](preprints/NVG_Seven_Theorems.pdf))
  Семь независимых теорем из единого объекта $\Phi = \mathcal{W}e^{i\theta}$: неопределённость Гейзенберга, правило Борна, коллапс волновой функции, сильное CP, стрела времени, смерть запутанности при $T_c$, квантовая гравитация без квантования.
