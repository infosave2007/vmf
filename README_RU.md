...
| 19 | Сумма масс нейтрино, отображение через GUT | См. Масса нейтрино из $\theta$-seesaw (строка 50) | ❌ Устарело (заменено строкой 50) |
...
| 22 | Топологическая масса аксиона | См. Масса нейтрино из $\theta$-seesaw (строка 50) | ❌ Устарело (объединено со строкой 50) |
