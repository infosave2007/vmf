...
| 30 | Температура реликтового излучения $T_{\rm CMB} = 2.725$ K | Выведена из масштаба отскока $T_b = 432.2$ МэВ при единичной нормировке масштаба отскока сегодня ([cmb_temperature.py](verification/nvg_cmb_temperature.py)) | ✅ Точное совпадение (+0.54σ) |
| 31 | Барионная асимметрия $\eta_B \approx 6 \times 10^{-10}$ | Выведена из масштабных соотношений неравновесного вымораживания при отскоке Генезиса ([baryon_asymmetry.py](verification/nvg_baryon_asymmetry.py)) | ✅ Точное совпадение (-0.63σ) |
