...
| 38 | Пик доли ПЧД как ТМ | Дискретная лестница масс $M_N = 0.38 \times 4^N M_\odot$ следует из теории; положение пика обилия ($N=-21$) и ширина ($\sigma_N = 1.3$) размещены в наблюдательно разрешённом астероидном окне ([pbh_dark_matter.py](verification/nvg_pbh_dark_matter.py)) | ⚙️ Лестница предсказана; обилие калибровано |
