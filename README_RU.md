...
1. **Эхо гравитационных волн:** Строгое предсказание $\Delta t_{\rm echo} = 22.00 \pm 0.01$ мс с учётом спина для слияния ЧД массой 65 $M_\odot$ (безпараметрическое и крайне робастное к дисперсии $M_{\Omega,0}$, проверяемое LIGO/Virgo).
