...
| Primordial GW Comb | f_GW(77) = 62.8 nHz | `nvg_primordial_gw_comb.py` | Frequencies derived (62.8 nHz, spacing 4^(-1/3)); amplitude discriminates V(W): quartic action -> no PTA signal, dilaton form -> NANOGrav band (nvg_recondensation_dynamics.py) |
