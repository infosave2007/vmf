...
print("      the script docstring. RETUNE APPLIED 2026-08: the tracked EOS")
print("      now uses gamma2 = 2.00 (script reports M_max = 2.13 on its")
print("      coarse grid; fine-grid value 2.218); the fork-B family in")
