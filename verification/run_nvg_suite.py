...
def generate_evidence_ledger(results_center):
    ledger = [
        ...
        {"claim": "Primordial GW Comb", "value": f"f_GW(77) = {results_center['f_gw_77']:.1f} nHz", "file": "nvg_primordial_gw_comb.py", "status": "Frequencies derived (62.8 nHz, spacing 4^(-1/3)); amplitude discriminates V(W): quartic action -> no PTA signal, dilaton form -> NANOGrav band (nvg_recondensation_dynamics.py)"},
