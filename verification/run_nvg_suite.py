...
def generate_evidence_ledger(results_center):
    ledger = [
        ...
        {"claim": "Baryon Asymmetry", "value": f"eta_B = {results_center['eta_b']:.2e}", "file": "nvg_baryon_asymmetry.py", "status": "OPEN PROBLEM — no mechanism in current field content (nvg_baryogenesis_bsm_closure.py); ansatz withdrawn as a claim"},
