...
def main():
    ...
    print("-" * 74)
    print("STATUS: RETIRED (2026-07). The theta-seesaw mapping (nvg_neutrino_seesaw.py,")
    print("Sigma = 59 meV) is adopted as the primary neutrino sector; this GUT-prior")
    print("mapping is retained for reference only.")
    print()
