...
print("VERDICT")
print("="*74)
print(" * GOOD: the sqrt-law is not arbitrary -- it is the exact mean-field extremum")
print("   of NVG's own quartic potential. That is a real derivation.")
print(" * BUT beta=1/2 is a mean-field ASSUMPTION. A QCD-anchored finite-density")
print("   transition sits in a 3D universality class -> beta = 0.326 (Ising) or")
print("   0.349 (XY), which the theory can test on EXISTING RHIC BES-II data.")
print(" * FALSIFIABLE: net-proton cumulant scaling near T_c=157 MeV selects beta;")
print("   and beta reshapes the modified-Friedmann bounce term (1-rho/rho_c)^{2beta},")
print("   feeding the e-folds, CMB low-l cutoff, and pre-bounce w(z) (DESI).")
print(" * So the melting exponent is ONE number that ties NS deep core, heavy-ion,")
print("   and cosmology together -- the single highest-leverage quantity to pin.")
